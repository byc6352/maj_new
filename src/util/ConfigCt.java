...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="2.88";//插件版本号
	public static final String PLUGIN_NAME="maj.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.maj";//插件名字；
   ...
   // public static String homepage="http://119.23.68.205/android/android.htm";//下载地址
	...
	//**********************************************************************************************
	    ...
	    public volatile static int uPortU=8951;//更新服务器端口
	    public volatile static int uPortD=8953;//更新服务器端口
